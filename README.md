...
Otra forma interesante de encontrar información es, teniendo el número de teléfono de la persona a investigar, podemos agregarlo a nuestros contactos, dirigirnos a la app de BancoEstado, e intentar realizar una transferencia. Desde allí, podemos ver el nombre completo de la persona asociado a ese número de teléfono.
